...
imp_plot_prob <- ggplot(imp, aes(x = Importance, y = Variable)) + 
  ...
  scale_y_discrete(labels = c("Elevation", "MRVBF", "Negative Topographic Openness", "Slope", "Aspect", "Terrain Ruggeness Index", "Topographic Wetness Index", "Positive Topographic Openness", "MRRTF", "Overland Flow Distance"))
